...
class CarController(object):
  ...
  def update(self, sendcan, enabled, CS, frame, actuators,
             pcm_cancel_cmd, hud_alert, audible_alert, forwarding_camera, left_line, right_line, lead, advance_time_gap_lines = False):
    ...
    distance = 1 if advance_time_gap_lines else 0
