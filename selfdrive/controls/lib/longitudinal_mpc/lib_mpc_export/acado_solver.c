...
acadoWorkspace.state[16] = acadoVariables.od[lRun1 * 3];
acadoWorkspace.state[17] = acadoVariables.od[lRun1 * 3 + 1];
acadoWorkspace.state[18] = acadoVariables.od[lRun1 * 3 + 2];
...
a[1] = (exp(((real_t)(2.9999999999999999e-01)*(((((((xd[1]*od[2])-((od[1]-xd[1])*od[2]))+((xd[1]*xd[1])/(real_t)(1.9620000000000001e+01)))-((od[1]*od[1])/(real_t)(1.9620000000000001e+01)))+(real_t)(4.0000000000000000e+00))-(od[0]-xd[0]))/(a[0]+(real_t)(1.0000000000000001e-01))))));
a[2] = (exp(((real_t)(6.5000000000000000e+00)-((real_t)(1.3500000000000001e+00)*xd[1]))));
a[3] = ((real_t)(1.0000000000000000e+00)/(a[0]+(real_t)(1.0000000000000001e-01)));
a[4] = (exp(((real_t)(2.9999999999999999e-01)*(((((((xd[1]*od[2])-((od[1]-xd[1])*od[2]))+((xd[1]*xd[1])/(real_t)(1.9620000000000001e+01)))-((od[1]*od[1])/(real_t)(1.9620000000000001e+01)))+(real_t)(4.0000000000000000e+00))-(od[0]-xd[0]))/(a[0]+(real_t)(1.0000000000000001e-01))))));
a[5] = (((real_t)(2.9999999999999999e-01)*(((real_t)(0.0000000000000000e+00)-((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00)))*a[3]))*a[4]);
a[6] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.9620000000000001e+01));
a[7] = (1.0/sqrt((xd[1]+(real_t)(5.0000000000000000e-01))));
a[8] = (a[7]*(real_t)(5.0000000000000000e-01));
a[9] = (a[3]*a[3]);
a[10] = (((real_t)(2.9999999999999999e-01)*((((od[2]-(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*od[2]))+((xd[1]+xd[1])*a[6]))*a[3])-((((((((xd[1]*od[2])-((od[1]-xd[1])*od[2]))+((xd[1]*xd[1])/(real_t)(1.9620000000000001e+01)))-((od[1]*od[1])/(real_t)(1.9620000000000001e+01)))+(real_t)(4.0000000000000000e+00))-(od[0]-xd[0]))*a[8])*a[9])))*a[4]);
a[11] = (real_t)(0.0000000000000000e+00);
a[12] = ((real_t)(1.0000000000000000e+00)/(((real_t)(5.0000000000000003e-02)*xd[1])+(real_t)(5.0000000000000000e-01)));
a[13] = (exp(((real_t)(6.5000000000000000e+00)-((real_t)(1.3500000000000001e+00)*xd[1]))));
a[14] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.3500000000000001e+00))*a[13]);
a[15] = ((real_t)(1.0000000000000000e+00)/((real_t)(1.0000000000000000e+00)+a[2]));
a[16] = (a[15]*a[15]);
a[17] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.9620000000000001e+01));
a[18] = (a[12]*a[12]);
a[19] = (real_t)(0.0000000000000000e+00);

/* Compute outputs: */
out[0] = a[1];
out[1] = (((od[0]-xd[0])-((((real_t)(2.5000000000000000e+00)/((real_t)(1.0000000000000000e+00)+a[2]))+(real_t)(1.5000000000000000e+00))+((((xd[1]*od[2])-((od[1]-xd[1])*od[2]))+((xd[1]*xd[1])/(real_t)(1.9620000000000001e+01)))-((od[1]*od[1])/(real_t)(1.9620000000000001e+01)))))/(((real_t)(5.0000000000000003e-02)*xd[1])+(real_t)(5.0000000000000000e-01)));
...
out[5] = a[10];
out[6] = a[11];
out[7] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*a[12]);
out[8] = ((((real_t)(0.0000000000000000e+00)-(((real_t)(0.0000000000000000e+00)-(((real_t)(2.5000000000000000e+00)*a[14])*a[16]))+((od[2]-(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*od[2]))+((xd[1]+xd[1])*a[17]))))*a[12])-((((od[0]-xd[0])-((((real_t)(2.5000000000000000e+00)/((real_t)(1.0000000000000000e+00)+a[2]))+(real_t)(1.5000000000000000e+00))+((((xd[1]*od[2])-((od[1]-xd[1])*od[2]))+((xd[1]*xd[1])/(real_t)(1.9620000000000001e+01)))-((od[1]*od[1])/(real_t)(1.9620000000000001e+01)))))*(real_t)(5.0000000000000003e-02))*a[18]));
...
out[4] = a[10];
out[5] = a[11];
out[6] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*a[12]);
out[7] = ((((real_t)(0.0000000000000000e+00)-(((real_t)(0.0000000000000000e+00)-(((real_t)(2.5000000000000000e+00)*a[14])*a[16]))+((od[2]-(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*od[2]))+((xd[1]+xd[1])*a[17]))))*a[12])-((((od[0]-xd[0])-((((real_t)(2.5000000000000000e+00)/((real_t)(1.0000000000000000e+00)+a[2]))+(real_t)(1.5000000000000000e+00))+((((xd[1]*od[2])-((od[1]-xd[1])*od[2]))+((xd[1]*xd[1])/(real_t)(1.9620000000000001e+01)))-((od[1]*od[1])/(real_t)(1.9620000000000001e+01)))))*(real_t)(5.0000000000000003e-02))*a[18]));
...
acadoWorkspace.objValueIn[4] = acadoVariables.od[runObj * 3];
acadoWorkspace.objValueIn[5] = acadoVariables.od[runObj * 3 + 1];
acadoWorkspace.objValueIn[6] = acadoVariables.od[runObj * 3 + 2];
...
acadoWorkspace.objValueIn[3] = acadoVariables.od[60];
acadoWorkspace.objValueIn[4] = acadoVariables.od[61];
acadoWorkspace.objValueIn[5] = acadoVariables.od[62];
...
acadoWorkspace.state[16] = acadoVariables.od[index * 3];
acadoWorkspace.state[17] = acadoVariables.od[index * 3 + 1];
acadoWorkspace.state[18] = acadoVariables.od[index * 3 + 2];
...
acadoWorkspace.state[16] = acadoVariables.od[60];
acadoWorkspace.state[17] = acadoVariables.od[61];
acadoWorkspace.state[18] = acadoVariables.od[62];
...
acadoWorkspace.objValueIn[4] = acadoVariables.od[lRun1 * 3];
acadoWorkspace.objValueIn[5] = acadoVariables.od[lRun1 * 3 + 1];
acadoWorkspace.objValueIn[6] = acadoVariables.od[lRun1 * 3 + 2];
